...
{
    public partial class IdentificationWindow : MetroFramework.Forms.MetroForm // Form
    {
        ...
        public IdentificationWindow(FPScanner fpScanner, LocalAFIS afis)
        {
        ...
        sideForm1 fm2;
        public IdentificationWindow(FPScanner fpScanner, LocalAFIS afis, string loggedinuser, string enteredUsername, sideForm1 fm)
        {
            Control.CheckForIllegalCrossThreadCalls = false;
            InitializeComponent();
        ...
        public IdentificationWindow(LocalAFIS afis)
        {
            Control.CheckForIllegalCrossThreadCalls = false;
            InitializeComponent();
        ...
        private void BindFPScannerEvents()
        {
            ...
            _fpScanner.OnFingerprintsDetected += _fpScanner_OnFingerprintsDetected_i;
        }
        ...
        void _fpScanner_OnFingerprintsDetected_i(List<Fingerprint> fingerprints)
        {
            _fpScanner.StopCapturing();
            ...
            switch (selected_fingers)
            {
                case "left":
                    ...
                    {
                        //Current.Despatcher 
                        IAsyncResult result = fm2.IdentifyWindow.BeginInvoke((MethodInvoker)delegate ()
                         // IAsyncResult result = this.BeginInvoke((MethodInvoker)delegate ()
                          //this.BeginInvoke((MethodInvoker)delegate ()
                          //this.Invoke((MethodInvoker)delegate ()
                          //fm2.IdentifyWindow.BeginInvoke((MethodInvoker)delegate ()
                          //Task.Run(()=>
                          {
