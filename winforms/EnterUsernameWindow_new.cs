...
{
    public partial class EnterUsernameWindow_new :  MetroFramework.Forms.MetroForm // Form //
    {
        ...
        public EnterUsernameWindow_new()
        {
            InitializeComponent();
        ...
        public EnterUsernameWindow_new(string message)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
        ...
        public EnterUsernameWindow_new(bool enroll)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
            //xamlButtonOK.Visible = false;
        ...
        public EnterUsernameWindow_new(bool enroll, sideForm1 fm)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
            //xamlButtonOK.Visible = false;
        ...
        public EnterUsernameWindow_new(EnrollmentWindow_new fm)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
            // xamlTextBoxUsername.Focus();
