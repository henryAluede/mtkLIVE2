...
{
    public partial class EnterUsernameWindow_IIN :  MetroFramework.Forms.MetroForm // Form //
    {
        ...
        public EnterUsernameWindow_IIN()
        {
            InitializeComponent();
        ...
        public EnterUsernameWindow_IIN(string message)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
        ...
        public EnterUsernameWindow_IIN(bool enroll)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
            //xamlButtonOK.Visible = false;
        ...
        public EnterUsernameWindow_IIN(bool enroll, sideForm1 fm)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
            //xamlButtonOK.Visible = false;
        ...
        public EnterUsernameWindow_IIN(EnrollmentWindow_new fm)
        {
            InitializeComponent();
            Control.CheckForIllegalCrossThreadCalls = false;
            // xamlTextBoxUsername.Focus();
